...
<head th:replace="fragments/common :: head('JA KOREA')">
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark" th:replace="fragments/common :: menu('home')">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
            <a class="nav-link" href="1index.php">교육실적 관리</a>
        </li>
    </div> 
</nav>
</header>
...
<main role="main" class="flex-shrink-0">
    <div class="container">
        <br>
        <h1 class="mt-5">JA Koera 사내 관리 사이트</h1>
        <p class="lead">회의실예약, 차량관리, 교재재고, 선수금, 교육실적을 한번에 관리</code>.</p>
